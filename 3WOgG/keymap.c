...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_voyager(
    ...
    KC_LEFT_CTRL,   MT(MOD_LALT, KC_Z),KC_X,           KC_C,           MT(MOD_LALT, KC_V),MT(MOD_LGUI, KC_B),                                KC_N,           KC_M,           KC_COMMA,       KC_DOT,         KC_SLASH,       KC_BSLS,        
                                                    LT(2, KC_ENTER),LT(1, KC_SPACE),                                KC_BSPC,        MT(MOD_LSFT, KC_SPACE)
  ),
  [1] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, MAC_SPOTLIGHT,  KC_LBRC,        KC_RBRC,        ST_MACRO_2,                                     KC_LEFT,        KC_DOWN,        KC_UP,          KC_RIGHT,       KC_TRANSPARENT, KC_TRANSPARENT, 
